  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col   xl:space-y-36 space-y-8 md:space-y-28">
        {/* // ? Project 0 - RTS-Imaging E-commerce (Image Right) */}
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96">
          ...
          <div className="hidden bg-AAprimary z-10  py-4 absolute md:grid grid-cols-12 w-full h-full  content-center">
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a href="https://rts-e-commerce.vercel.app/" target="_blank" rel="noreferrer">
              ...
              <Img src="/projects/RTS.png" alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          {/* left Content */}
          <div className="md:absolute py-4 md:grid md:grid-cols-12 w-full h-full content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0 md:order-2">
              <div className="relative w-full h-full">
                ...
                <Img src="/projects/RTS.png" alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            <div className="px-8 pt-8 sm:pt-12 md:py-0 xl:col-span-6 col-span-8 flex flex-col items-start space-y-3 md:order-1">
              <div className="flex flex-col space-y-1 z-10">
                <span className="text-AAsecondary text-base">E-commerce Project</span>
                <a href="https://rts-e-commerce.vercel.app/" target="_blank" rel="noopener noreferrer">
                  <span className="md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">RTS-Imaging</span>
                </a>
              </div>
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6 z-10">
                <p className="text-gray-300 md:text-gray-400 text-left">
                  Developed a robust <span className="text-AAsecondary">e-commerce website</span> for <span className="text-AAsecondary">RTS-Imaging</span>, specializing in <span className="text-AAsecondary">printers</span> and <span className="text-AAsecondary">printer parts</span>. The platform features advanced product search, secure payment integration, and a seamless shopping experience tailored for B2B and B2C customers.
                </p>
              </div>
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                <a href="https://rts-e-commerce.vercel.app/" target={"_blank"} rel="noreferrer">
                  <ExternalLink url={"https://rts-e-commerce.vercel.app/"} router={router} />
                </a>
              </div>
            </div>
          </div>
        ...
        {/* // ? Project 00 - The Diet Remedie Portfolio (Image Left) */}
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96">
          {/* Left image */}
          <div className="hidden bg-AAprimary z-10  py-4 absolute md:grid grid-cols-12 w-full h-full  content-center">
            <div className="relative rounded w-full h-full col-span-7 ">
              <a href="https://www.thedietremedies.com/" target="_blank" rel="noreferrer">
                <div className="absolute w-full h-full rounded bg-AAprimary transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"></div>
              </a>
              <Img src="/projects/Dietation.png" alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          {/* right Content */}
          <div className="md:absolute py-4 md:grid md:grid-cols-12 w-full h-full content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src="/projects/Dietation.png" alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            <div className="px-8 pt-8 sm:pt-12 md:py-0 xl:col-span-6 xl:col-start-7 col-start-5 col-span-8 flex flex-col items-start md:items-end space-y-3">
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-AAsecondary text-base">Portfolio Website</span>
                <a href="https://www.thedietremedies.com/" target="_blank" rel="noopener noreferrer">
                  <span className="md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">The Diet Remedie</span>
                </a>
              </div>
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6 z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  Built a modern <span className="text-AAsecondary">portfolio website</span> for a dietitian, <span className="text-AAsecondary">The Diet Remedie</span>, to showcase services, client testimonials, and nutrition programs. The site features a clean design, appointment booking, and a blog for sharing health tips and diet plans.
                </p>
              </div>
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                <a href="https://www.thedietremedies.com/" target={"_blank"} rel="noreferrer">
                  <ExternalLink url={"https://www.thedietremedies.com/"} router={router} />
                </a>
              </div>
            </div>
          </div>
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          >
           ...
           transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/projects/Chainzoku.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0 md:order-2">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/projects/Chainzoku.png"} alt={"Project Screen shot"} className={`w-full h-full`} />
              </div>
            </div>
            ...
            >
              <div className="flex flex-col space-y-1  z-10">
                <span className="text-AAsecondary text-base">Chainzoku</span>
                <a href="https://chain-zoku.vercel.app/" target="_blank" rel="noopener noreferrer">
