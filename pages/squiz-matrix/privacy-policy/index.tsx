          ...
          <div className="px-6 py-8 space-y-8">
            ...
            <section>
              ...
              <div className="mt-4 bg-gray-50 rounded-lg p-6">
                <p className="text-gray-900 font-medium">Akash Anaflous - Developper</p>
                <div className="flex space-x-2">
                  <p className="text-gray-600">Email:</p>
                  <a href="mailto:akashpatel115347@gmail.com" className="text-blue-600 hover:text-blue-800 underline">
                    akashpatel115347@gmail.com
                  </a>
                </div>
              </div>
            </section>
